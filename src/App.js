  ...
  return (
    <div className="App">
      ...
      <div className="mb-6 text-left">
        ...
        <p className="text-gray-100 text-base">Loan Origination System</p>
            <h1 className="text-8xl md:text-8xl mb-2">Login to your <span style={{color:"#8204FF"}}>Account</span> </h1>
